...
export default function BookingForm() {
  ...
  const S = {
    ...
    form: { background: '#fff', borderRadius: '28px', padding: '44px', boxShadow: '0 8px 40px rgba(0,100,160,0.08)' },
    secTitle: { fontSize: '0.9rem', fontWeight: 700, color: '#B8860B', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '14px', marginTop: '28px', display: 'flex', alignItems: 'center', gap: '8px' },
    label: { fontSize: '0.85rem', fontWeight: 600, color: '#5E7D9E', marginBottom: '6px', display: 'block' },
    input: (err) => ({ padding: '12px 16px', borderRadius: '12px', border: `1.5px solid ${err ? '#FF6B6B' : 'rgba(212,175,55,0.25)'}`, fontSize: '0.95rem', color: '#B8860B', outline: 'none', background: '#f8fcff', width: '100%', boxSizing: 'border-box' }),
    ...
    counterBtn: { width: '38px', height: '38px', borderRadius: '50%', border: '2px solid rgba(212,175,55,0.4)', background: '#fff', color: '#B8860B', fontSize: '1.2rem', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' },
    counterNum: { fontSize: '1.5rem', fontWeight: 900, color: '#B8860B', minWidth: '36px', textAlign: 'center' },
    toggleRow: (active) => ({ display: 'flex', alignItems: 'center', gap: '14px', padding: '16px 18px', borderRadius: '14px', background: active ? 'rgba(212,175,55,0.08)' : '#f8fcff', border: `1.5px solid ${active ? 'rgba(212,175,55,0.4)' : 'rgba(212,175,55,0.15)'}`, cursor: 'pointer', userSelect: 'none', marginBottom: '12px' }),
    ...
    infoBox: { background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: '10px', padding: '10px 14px', fontSize: '0.82rem', color: '#15803d', marginBottom: '16px', display: 'flex', alignItems: 'flex-start', gap: '8px' },
    submitBtn: { width: '100%', padding: '16px', borderRadius: '14px', background: loading ? '#ccc' : 'linear-gradient(135deg, #D4AF37, #FFD700)', color: '#fff', fontWeight: 800, fontSize: '1.05rem', marginTop: '28px', boxShadow: '0 8px 32px rgba(212,175,55,0.4)', letterSpacing: '0.3px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: loading ? 'not-allowed' : 'pointer' },
