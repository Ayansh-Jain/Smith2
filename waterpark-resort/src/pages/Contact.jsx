...
export default function Contact() {
  ...
  const s = {
    ...
    card: { background: '#fff', borderRadius: '28px', padding: '50px', boxShadow: '0 8px 40px rgba(0,100,160,0.08)' },
    cardTitle: { fontSize: '1.6rem', fontWeight: 900, color: '#B8860B', marginBottom: '8px' },
    cardSub: { color: '#5E7D9E', fontSize: '0.95rem', marginBottom: '36px' },
    iGroup: { marginBottom: '20px' },
    label: { display: 'block', fontSize: '0.87rem', fontWeight: 600, color: '#5E7D9E', marginBottom: '8px' },
    input: (err) => ({ width: '100%', padding: '13px 16px', borderRadius: '12px', border: `1.5px solid ${err ? '#FF6B6B' : 'rgba(212,175,55,0.25)'}`, fontSize: '0.95rem', color: '#B8860B', background: '#f8fcff', outline: 'none', boxSizing: 'border-box' }),
    textarea: (err) => ({ width: '100%', padding: '13px 16px', borderRadius: '12px', border: `1.5px solid ${err ? '#FF6B6B' : 'rgba(212,175,55,0.25)'}`, fontSize: '0.95rem', color: '#B8860B', background: '#f8fcff', outline: 'none', resize: 'vertical', minHeight: '130px', boxSizing: 'border-box' }),
    row2: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' },
    err: { color: '#FF6B6B', fontSize: '0.82rem', marginTop: '4px' },
    btn: { width: '100%', padding: '15px', borderRadius: '14px', background: 'linear-gradient(135deg, #D4AF37, #FFD700)', color: '#fff', fontWeight: 800, fontSize: '1.02rem', boxShadow: '0 6px 24px rgba(212,175,55,0.4)', marginTop: '8px' },
    ...
    success: { textAlign: 'center', padding: '60px 40px', background: '#fff', borderRadius: '28px', boxShadow: '0 8px 40px rgba(0,100,160,0.08)' },
  };
