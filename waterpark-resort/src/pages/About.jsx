...
export default function About() {
  const s = {
    ...
    p: { color: '#5E7D9E', lineHeight: 1.85, fontSize: '0.97rem', marginBottom: '16px' },
    ...
    tlDesc: { color: '#5E7D9E', fontSize: '0.93rem', lineHeight: 1.7 },
    valGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '24px' },
    valCard: { background: '#fff', borderRadius: '20px', padding: '32px 28px', boxShadow: '0 6px 30px rgba(0,100,160,0.07)', border: '1px solid rgba(212,175,55,0.1)' },
